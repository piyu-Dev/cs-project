...
print()
print('WELCOME TO @AMMO GAMING')
print()
print('*****INSTRUCTIONS*****')
print()
print('1. press "W" for upper jump.')
print('2. press "A" for left.')
print('3. press "D" for right.')
print('4. press "L" for shooting.')
print('5. press "H" for ammo.')
print('THANK YOU')
